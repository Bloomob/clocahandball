...
if(isset($_POST)) {
    ...
    $DestinationDirectory   = '/www/images/photos/'; //Upload Directory ends with / (slash)
    $Quality                = 90;
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
        ...
        echo '<tr>';
        echo '<td align="center"><img src="/images/photos'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail" height="'.$ThumbSquareSize.'" width="'.$ThumbSquareSize.'"></td>';
        echo '</tr><tr>';
        echo '<td align="center"><img src="/images/photos'.$NewImageName.'" alt="Resized Image" height="'.$ResizedHeight.'" width="'.$ResizedWidth.'"></td>';
        echo '</tr>';
        echo '</table>';
