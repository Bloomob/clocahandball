<?php
	...
	if(ajout_match($categorie, $newDate, $newHeure, $lieu, $gymnase, $adresse, $ville, $code_postal, $competition, $niveau, $journee, $tour, $adversaire1, $adversaire2, $adversaire3, $dom1, $ext1, $dom2, $ext2, $dom3, $ext3, $joue, $arbitre, $classement) && !$erreur){
		echo "Le match a bien &eacute;t&eacute; ajout&eacute; !";
	}
	else {
		echo "Le match n'a pas &eacute;t&eacute; ajout&eacute; !";
	}
?>