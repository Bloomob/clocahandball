...
<div class='popin'>
	...
	<div class="ligne">
		...
		<div class="colone2">
			<input type="checkbox" id="slider" class="champ" <?=($uneActu->getSlider())?"checked":'';?>/>
		</div>
	</div>
	<div class="ligne">
		<div class="colone1">
		...
		<div class="colone2">
			<select id="importance" class="champ">
	...
	<div class="ligne">
		...
		<div class="colone2">
			<input type="checkbox" id="publie" class="champ" <?=($uneActu->getPublie())?"checked":'';?>/>
		</div>
	</div>
